					...
					<div class="col-sm-12">
						<div class="text">
							<div class="form" style="min-width:60vw">
								<form action="makecompetition_" method="post" style="width:40%;min-width:250px;box-shadow:2px 2px 11px 11px #DDDDDD;" name="vlogin" id="needs-validation" novalidate>
          <table>
          	<tr>
          	<td>
          	...
          	<td>
          		<center><h6 style="color:#3160B6">CONTRIBUTE in DEVELOPING DEVELOPERS</h6></center>
          	</td>
          </tr>
  <div class="form-group">
            ...
            <tr>
              ...
              <td style="padding-top: 15px">
                ...
                <input type="text" class="form-control" name="nameofcompetition" size=39 maxlength=50 placeholder="COMPETITION NAME" style="border-width: 1px;color:#357bd8;" id="validationCustom01"  required/>
             <div class="invalid-feedback">
                  It seems you haven't entered a valid COMPETITION NAME.
                </div>
              </td>
              <tr><td>
            ...
            <tr>
              ...
              <td style="padding-top: 15px">
                ...
                <input type="date" class="form-control" name="start"  size=39 maxlength=50 placeholder="START DATE" style="border-width: 1px;color:#357bd8;" id="validationCustom01"  required/>
             <div class="invalid-feedback">
            ...
            <tr>
              ...
              <td style="padding-top: 15px">
                    ...
                    <input type="date" class="form-control" name="end"  size=39 maxlength=50 placeholder="END DATE" style="border-width: 1px;color:#357bd8;" id="validationCustom01"  required/>
             <div class="invalid-feedback">
            ...
            <tr>
              ...
              <td style="padding-top: 15px">
                ...
                <input type="text" class="form-control" name="describe" size=39 maxlength=50 placeholder="Description" style="border-width: 1px;color:#357bd8;" id="validationCustom01"  required/>
             <div class="invalid-feedback">
                  Please enter a one liner description of the competition.
                </div>
              </td>
              <tr><td>
