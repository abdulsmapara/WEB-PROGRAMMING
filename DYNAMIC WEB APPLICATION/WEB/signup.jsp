<%-- 
    Document   : signup
    Created on : Apr 12, 2018, 8:03:12 PM
...
<body style="overflow-x:hidden !important ">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="about.jsp" style="color:#4a89dc">ABOUT</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="login.jsp" style="color:#4a89dc;">LOG-IN</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="signup.jsp" style="color:#4a89dc;">SIGN-UP</a>
      </li>
    </ul>
	...
	<div class="main_div" style="background: url('http://www.codeingzone.in/header-bg.jpg');">
		...
		<div class="row">
			<div class="container">
				<div class="text">
					<hgroup>
						<h1 style="color:white">CART-ZONE</h1>
					...
					<div class="col-sm-12">
						<div class="text">
							<div class="form" style="min-width:60vw">
                                                            <form  action="signupservlet_" method="POST"  style="width:40%;min-width:250px;box-shadow:2px 2px 11px 11px #DDDDDD;" name="vlogin" id="needs-validation" novalidate>
          <table>
          	<tr>
          	<td>
          ...
          <div class="form-group">
            ...
            <tr>
              ...
              <td style="padding-top: 15px">
                ...
                <input type="text" class="form-control" name="name" id="name" size=39 maxlength=50 placeholder="NAME" style="border-width: 1px;color:#357bd8;" id="validationCustom01" pattern="[A-Za-z]{2,}+\W+[A-Za-z]{2,}+\W+[A-Za-z]{2,}" required />
             <div class="invalid-feedback">
                  It seems you have not entered a correct NAME
                </div>
              </td>
            ...
            <tr>
              ...
              <td style="padding-top: 15px">
                ...
                <input type="text" class="form-control" name="email" id="email" size=39 maxlength=50 placeholder="E-MAIL" style="border-width: 1px;color:#357bd8;" id="validationCustom01" pattern="[a-z0-9._]+@+[a-z]+\.+[a-z]{2,4}" required/>
             <div class="invalid-feedback">
                  It seems you have not entered a correct email-address
                </div>
              </td>
            ...
            <tr>
              ...
              <td style="padding-top: 15px">
                ...
                <input type="PASSWORD" class="form-control" name="password" id="pass" size=39 maxlength=50 placeholder="PASSWORD" style="border-width: 1px;color:#357bd8;" id="validationCustom01"  required/>
             <div class="invalid-feedback">
