  ...
  <ul class="dropdown-menu dropdown-menu-right" role="menu" style="overflow-x:hidden;background:white">
      ...
      <a class="dropdown-item" href="profile.jsp" style="background:white"><span class="logout_style"><i class="fa fa-fw fa-user"></i>PROFILE</span></a>
          <a class="dropdown-item" href="loggedout"  style="background:white"><span class="logout_style"><i class="fa fa-fw fa-sign-out"></i>LOGOUT</span></a>                      
            ...
            <div class="row">
                <div class="col-sm-10">
                    <h3 style="text-align:center;font-size:15px;">QUESTION-2:</h3>
...
<div  data-pym-src="https://www.jdoodle.com/embed/v0/tf6"></div>

    <p>
    <h3>PROBLEM</h3>
    <h6>GIVEN A SNIPPET OF CODE DETERMINE IF THE PROGRAM LEAKS MEMORY OR DEALS WITH DANGLING POINTERS OR BOTH OR NONE</h6>
    </p>
    ...
    <form action="evaluate">
        ...
        <input type="radio" name="q1" value="1" />    Memory Leak but not Dangling pointer<br/>
        <input type="radio" name="q1" value="2" />    Dangling Pointer but not Memory Leak<br/>
        <input type="radio" name="q1" value="3" />    Memory Leak as well as Dangling pointer<br/>
 ...
 <div class="row">
     <div class="col-sm-4"></div>
     <div class="col-sm-4" style="padding-left:10%">
     <a href="warmup_.jsp" class="btn btn-info">
         PREV
     </a>

     <a href="#" class="btn btn-info" disabled="true">
         NEXT
     </a>
    </div>
</div>
 ...
 <%
       Class.forName("com.mysql.jdbc.Driver");
                    ...
                    if(rs!=null)
                    {
                        ...
                        while(rs.next())
                        {
                            if(rs.getString("identity").equals("warmup1")){
